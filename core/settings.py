...
SECRET_KEY = 'django-insecure-pb+10_7hsie2vpm=al=ld$0vy47*(2woc*dn&ow$@s^6dhak0@'
...
#\q "quite" \du "see database users" \l "see database list" \c "connect to postgresql database - (no need)"
#GRANT ALL PRIVILEGES ON SCHEMA public TO youruser;
#GRANT ALL PRIVILEGES ON DATABASE book_lending_service_db TO youruser;
#ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO youruser;
#ALTER DATABASE book_lending_service_db OWNER TO youruser;
